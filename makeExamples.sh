...
python vortexfitting.py -i ../data/adim_vel_{:06d}.dat -o ../results/adim_vel_000010 -first 10 -last 10 -t 5 -b 20 -ft piv_tecplot 
exit
...
python vortexfitting.py -i ../data/dim_vel_{:06d}.dat -o ../results/dim_vel_000010 -first 10 -last 10 -mf ../data/mean.dat -ft piv_tecplot -t 50 -rmax 2
