...
python3 vortexfitting.py -i ../data/example_vel_{:06d}.dat -o ../results/example_temporal_series -mf ../data/example_mean.dat -first 5 -last 6 -t 50 -ct 0.5 -ft piv_tecplot 
