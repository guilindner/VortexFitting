...
if __name__ == '__main__':
    ...
    def test_oseen(core_radius, gamma, dist, xdrift, ydrift, u_advection, v_advection,theoretical_model):
    ...
    test_oseen(0.2, 10, 10, 0.0, 0.0, 0.01, 0.01, 'lamb-oseen')
    test_oseen(0.2, 10, 10, 0.2, 0.2, 0.01, 0.01, 'lamb-oseen')
    test_oseen(0.9, 40, 10, 0.0, 0.0, 0.01, 0.01, 'lamb-oseen')
    test_oseen(0.9, 40, 10, 0.2, 0.2, 0.01, 0.01, 'lamb-oseen')
